...
/* Create_Temp
   ...
   Postcondition : returns a temp symbol. 
...
void PrintSym(struct SymbTab *s)
{
    ...
    case ID_Sub_Type_Extern : string = "Extern"; break; 
     ...
     case ID_Sub_Type_String: string = "String"; break;
     ...
     case A_Decaf_BOOL: display_type = "BOOL " ; break; // added lab7
     case A_Decaf_VOID : display_type = "VOID" ; break; // added lab7
				   //MISSING
